...
const Navbar = () => {
    return (
        <header className="w-full flex px-3 py-2 border-b-2 border-b-primary-dark bg-primary-yellow items-center justify-between shadow-lg shadow-primary-dark/30">
